...
<page size="A4">
            ...
            <tr>
                <td>
                    <div class="company-info">
                        ...
                        <div class="date-box">
                            <label>@lang('write_off.date',[],$lang): </label>
                            <span>{!! $date !!}</span>
                        </div>
                    </div>
                </td>
    ...
    <div class="invoice-table-wrap">
        <table class="invoice-table">
            <thead>
            <th>@lang('write_off.client',[],$lang)</th>
            <th>{!! $client_name !!}</th>
            </thead>
            <tbody>
            <tr>
                <td>
                    @lang('write_off.receipt_no',[],$lang)
                </td>
                <td>
                    {!! $receipt_id !!}
                </td>
            ...
            <tr>
                <td>
                    @lang('write_off.principal_amount',[],$lang)
                </td>
                <td>
                    {!! $principal !!}
                </td>
            ...
            <tr>
                <td>
                    @lang('write_off.origination_fee',[],$lang)
                </td>
                <td>
                    {!! $origination !!}
                </td>
            ...
            <tr>
                <td>
                    @lang('write_off.renewal_fee',[],$lang)
                </td>
                <td>
                    {!! $renewal !!}
                </td>
            ...
            <tr>
                <td>
                    @lang('write_off.debt_collection_fee',[],$lang)
                </td>
                <td>
                    {!! $debt_collection_fee !!}
                </td>
            ...
            <tr class="total-block">
                <td>
                    @lang('write_off.payment_type',[],$lang)
                </td>
                <td>{!! $loan_transaction !!}</td>
            </tr>
            <tr>
                <td>
                    @lang('write_off.total_amount_due',[],$lang)
                </td>
                <td>{!! $due_amount !!}</td>
            </tr>
            <tr>
                <td>
                    @lang('write_off.deduction_write_off',[],$lang)
                </td>
                <td>{!! $deduction !!}</td>
            </tr>
            <tr class="total-block">
                <td>
                    @lang('write_off.total_amount_paid',[],$lang)
                </td>
                <td>{!! $payment_amount !!}</td>
            </tr>
            <tr>
                <td>
                    @lang('write_off.currency',[],$lang)
                </td>
                <td>{!! $currency !!}</td>
            </tr>
            <tr>
                <td>
                    @lang('write_off.account_status',[],$lang)
                </td>
