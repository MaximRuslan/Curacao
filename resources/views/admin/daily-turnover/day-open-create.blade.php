<div id="dayOpenModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true"
     style="display: none;">
    <div class="modal-dialog">
        <form action="{{route('daily-turnovers.dayopen.store')}}" id="dayopenForm" onsubmit="return SaveDayOpen(this)">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {!!Form::text('date',date('d/m/Y'), ['class'=>'form-control old-date-picker','placeholder'=>'Date','required'])!!}
