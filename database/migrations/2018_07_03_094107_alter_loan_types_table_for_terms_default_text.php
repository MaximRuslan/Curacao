...
class AlterLoanTypesTableForTermsDefaultText extends Migration
{
    /**
     * Run the migrations.
     *
...
<p class="western" lang="es-CO" style="margin-bottom: 0in;">&nbsp;</p>
<p class="western" style="margin-bottom: 0in;">&nbsp;</p>';
        Schema::table('loan_types', function (Blueprint $table) use ($str) {
            $table->longText('loan_agreement_eng')->default($str)->change();
            $table->longText('loan_agreement_esp')->default($str)->change();
            $table->longText('loan_agreement_pap')->default($str)->change();
        });
    }
    ...
    public function down()
    {
        Schema::table('loan_types', function (Blueprint $table) {
            $table->longText('loan_agreement_eng')->default('')->change();
            $table->longText('loan_agreement_esp')->default('')->change();
            $table->longText('loan_agreement_pap')->default('')->change();
        });
    }
}
