...
class AlterCountriesTableForTermsDefaultText extends Migration
{
    /**
     * Run the migrations.
     *
...
<li>Caribbean Cash or the Third Party Provider reserves the right to terminate your use of &ldquo;Froggy&rdquo; and the associated Third Party Provider products and services if you decline or withdraw consent to receive electronic Communications.</li>
        ...
        Schema::table('countries', function (Blueprint $table) use ($str) {
            $table->longText('terms_eng')->default($str)->change();
            $table->longText('terms_esp')->default($str)->change();
            $table->longText('terms_pap')->default($str)->change();
        });
    }
    ...
    public function down()
    {
        Schema::table('countries', function (Blueprint $table) {
            $table->longText('terms_eng')->default(null)->change();
            $table->longText('terms_esp')->default(null)->change();
            $table->longText('terms_pap')->default(null)->change();
        });
    }
}
