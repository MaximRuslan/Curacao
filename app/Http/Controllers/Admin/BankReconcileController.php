...
class BankReconcileController extends Controller
{
    ...
    {
        return view('admin.bank.reconcile');
    }
    ...
    public function indexDatatable()
    {
        ...
        } elseif (request('reconcile_type') == 2) {
            $loan_transactions->whereNotNull('loan_transactions.reconciled_at');
        } elseif (request('reconcile_type') == 3) {
        ...
        return DataTables::of($credits)
            ...
            ->addColumn('action', function ($data) {
                if ($data->reconciled_at == null) {
                    ...
                    return "<a href='javascript:;' data-toggle='tooltip' title='Reconcile' data-id='$data->id' data-type='$type' class='$iconClass btn-danger reconcileBank'>
    ...
    public function audit()
    {
        ...
        $data['years'] = $years;
        return view('admin.bank.audit', $data);
    }
